...
module.exports = function(RED) {
    function omiNodeV9(n) {
        RED.nodes.createNode(this,n);
        var node = this;
        this.on('input', function(msg) {
            //console.log("/Users/youradmin/.node-red/node_modules/omiNodeV9cons/omiNodeV9cons.js");
            //msg.payload = "events";
            //node.send(msg);
            var path_InfoItem, token, operations, ttl, interval, callback, newest, oldest, begin, end, value, reqID, metadata, readTypes;

            var omiNodeV9cons = require('node-red-contrib-omiNodeV9/omiNodeV9cons/omiNodeV9cons.js');
            //console.log("toto");
            var omiN = new omiNodeV9cons();
...
RED.nodes.registerType("omiNodeV9",omiNodeV9);
