...
const BASE_URL = 'https://api.omiNodeV9cons.net';
 ...
 * @param args
 */
 var omiNodeV9cons = function (args) {
  EventEmitter.call(this);
  //this.authenticate(args);
  //this.path_InfoItem="tt";
};

util.inherits(omiNodeV9cons, EventEmitter);
 ...
 * @returns {Error}
 */
 omiNodeV9cons.prototype.handleRequestError = function (err, response, body, message, critical) {
  var errorMessage = "";
...
*/
omiNodeV9cons.prototype.ReadInfoItem = function (options, oper_type, callback) {
...
//console.log("tttttttttttttt");
    ...
    var err_odf=xmlDoc.getElementsByTagName("result")[0].childNodes[0].getAttribute("returnCode");
    //console.log(err_odf);
...
@options: all necessary paramters (e.g., TTL, newest, oldest...) entered via Node-Red UI
*/
omiNodeV9cons.prototype.BuiltReqWs = function (options, oper_type) {
  var xmlmsg_omiodf, xmlmsg_odf;
  var DOMParser = require('xmldom').DOMParser;
...
function createOMIODF_Write(options,ODFpayload) {
  var OpenTag_OMIheader_withoutTTL= '<?xml version="1.0"?><omiEnvelope xmlns="http://www.opengroup.org/xsd/omi/1.0/" version="1.0" ttl="';
  var CloseTag_OMIheader_part2= '><write msgformat="odf"><msg><Objects xmlns="http://www.opengroup.org/xsd/odf/1.0/">';
  var CloseTag_OMIfooter='</Objects></msg></write></omiEnvelope>';
...
function createOMIODF_Cancel(options,ODFpayload) {
  var OpenTag_OMIheader_withoutTTL= '<?xml version="1.0"?><omiEnvelope xmlns="http://www.opengroup.org/xsd/omi/1.0/" version="1.0" ttl="';
  var CloseTag_OMIheader_part2= '><cancel xmlns="omi.xsd">';
  var CloseTag_OMIfooter='</cancel></omiEnvelope>';
  var OMIODF_msg=OpenTag_OMIheader_withoutTTL.concat(options.ttl,'"',CloseTag_OMIheader_part2,ODFpayload,CloseTag_OMIfooter);
